node{
    ...
    stage('Run ZAP for DAST'){
        ...
        // sh 'zap.sh'
            ...
            sh 'ssh -p 8877  soselab@140.121.197.135 "docker run -v /home/Desktop/test:/zap/wrk/:rw -t owasp/zap2docker-stable zap-baseline.py -t http://localhost:8080/mask-0.0.1-SNAPSHOT/ -r ~/Desktop/report.html"'
